...
Второй компонент позволяет найти в подземелье Айреникуса сумку, вмещающую 38 предметов.
...
Амулет Стабильности Времени при неустановленном ToB может разрушить игру. DEPRECATED as of v5.0.0.
