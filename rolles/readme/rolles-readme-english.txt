...
The first component adds a new character, Rolles, who can update items like Cromwell does, and also sells a few scrolls and items. You can find him on Waukeen's Promenade above the entrance to Adventurer Mart.
The second component adds a Bag of Holding (capacity: 18 items) in Irenicus Dungeon.
...
4. Known problems
=================
Necklace of Time Stability may crash game, if ToB is not installed.
